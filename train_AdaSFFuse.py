# AdaSFFuse #   python -m torch.distributed.launch --nproc_per_node=6 --master_port=1234 --use_env train_AdaSFFuse.py
#
import os
...
def main(json_path='/options/train_AdaSFFuse_vif.json'):  # TODO:1 
    ...
    parser.add_argument('--opt', type=str, default='/options/train_AdaSFFuse_vif.json', help='Path to option JSON file.') # TODO:2
