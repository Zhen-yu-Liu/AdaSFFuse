# MambaDFuse #   python -m torch.distributed.launch --nproc_per_node=6 --master_port=1234 --use_env train_MambaDFuse.py
#
import os
...
def main(json_path='/mnt/mydisk1/wangfei/mymamba2/options/mymamba2/train_mambadfuse_vif.json'):  # TODO:1 
    ...
    parser.add_argument('--opt', type=str, default='/mnt/mydisk1/wangfei/mymamba2/options/mymamba2/train_mambadfuse_vif.json', help='Path to option JSON file.') # TODO:2
    ...
    if opt['datasets']['dataset_type'] in ['mef_GT', 'mff_GT']:
        ...
        need_GT = False
    for epoch in range(5000):  # keep running  # vif 5000
