...
os.environ["CUDA_VISIBLE_DEVICES"] = "0,1"                                                                 # TODO:1 
...
def main():
    ...
    parser.add_argument('--model_path', type=str,
                        default='/checkpoint/VIF/Infrared_Visible_Fusion/models')
    parser.add_argument('--iter_number', type=str,
                        default='60000')                                                                   # TODO:2
    parser.add_argument('--root_path', type=str, default='/imagefusion/test',                              # TODO:3
                        help='input test image root folder')
    parser.add_argument('--dataset', type=str, default='IVF',                                              # TODO:4
                        help='input test image name')
    parser.add_argument('--A_dir', type=str, default='infrared',
                        help='input test image name')
    parser.add_argument('--B_dir', type=str, default='visible',
                        help='input test image name')
