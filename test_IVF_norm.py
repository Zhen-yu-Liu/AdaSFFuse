...
for img_name in os.listdir(os.path.join(root_path_with_model, "infrared")):
    ir = read_image_to_tensor(os.path.join(root_path_with_model, "infrared", img_name))
    vi = read_image_to_tensor(os.path.join(root_path_with_model, "visible_Y", 'test' + img_name))
    fi = read_image_to_tensor(os.path.join(fuse_path, img_name))
