...
if __name__ == "__main__":
    ...
    #   DDP模式：
    #       设置            distributed = True
    #       在终端中输入    CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4 --master_port=8888 --use_env train.py
    #---------------------------------------------------------------------#
    distributed     = True
    #---------------------------------------------------------------------#
    ...
    #------------------------------------------------------------------#
    save_dir            = 'logs_5.5_fusion_ours'                                               #TODO:2
    #------------------------------------------------------------------#
    ...
    #------------------------------------------------------#
    train_annotation_path   = '2007_train_vis.txt'                                              #TODO:3
    val_annotation_path     = '2007_val_vis.txt'
